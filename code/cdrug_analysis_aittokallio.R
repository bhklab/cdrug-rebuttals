...
boxplot(list("GE"=ge.between, "AUC"=diag(auc.between), "IC50"=diag(ic50.between)), main="Concordance between cell lines\nPearson", ylab="Pearson correlation", sub=ss, ylim=yylim, col="lightgrey", pch=20, border="black")
dev.off()
